                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      ...
                      <a href="/BTL/mvc/views/Admin_pages/#" class="text-dark ml-auto mb-3 mb-sm-0"> View all Products</a>
                    </div>
                    ...
                    <div class="d-flex mt-4 flex-wrap">
                      ...
                      <nav class="ml-auto">
                        <ul class="pagination separated pagination-info">
                          <li class="page-item"><a href="/BTL/mvc/views/Admin_pages/#" class="page-link"><i class="icon-arrow-left"></i></a></li>
                          <li class="page-item active"><a href="/BTL/mvc/views/Admin_pages/#" class="page-link">1</a></li>
                          <li class="page-item"><a href="/BTL/mvc/views/Admin_pages/#" class="page-link">2</a></li>
                          <li class="page-item"><a href="/BTL/mvc/views/Admin_pages/#" class="page-link">3</a></li>
                          <li class="page-item"><a href="/BTL/mvc/views/Admin_pages/#" class="page-link">4</a></li>
                          <li class="page-item"><a href="/BTL/mvc/views/Admin_pages/#" class="page-link"><i class="icon-arrow-right"></i></a></li>
                        </ul>
                      </nav>
                    </div>
                  </div>

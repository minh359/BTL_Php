            ...
            <tbody>
              ...
              while ($row = mysqli_fetch_array($data["source"]["sp"])) {
                ...
                <td style='text-align: center;'>
                    <a href='/BTL/Admin/CrudUser/View/".$row["username"]."/'><i class='icon-eye'></i></a>
                    <a href='/BTL/Admin/CrudUser/Update/".$row["username"]."/'><i class='icon-wrench'></i></a>
                    <a href='/BTL/Admin/CrudUser/Delete/".$row["username"]."'><i class='icon-trash'></i></a>
                </td>
                </tr>";
              }
              ?>

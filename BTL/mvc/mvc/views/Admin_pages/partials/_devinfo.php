                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      ...
                      <a href="../mvc/views/Admin_pages/#" class="text-dark ml-auto mb-3 mb-sm-0"> View all Products</a>
                    </div>
                    <div class="table-responsive border rounded p-1">
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <img class="img-sm rounded-circle" src="../mvc/views/Admin_pages/images/faces/face1.jpg" alt="profile image"> Katie Holmes
                            </td>
                            <td>$3621</td>
                            <td><img src="../mvc/views/Admin_pages/images/dashboard/alipay.png" alt="alipay" class="gateway-icon mr-2"> alipay</td>
                            <td>04 Jun 2019</td>
                            <td>18 Jul 2019</td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <img class="img-sm rounded-circle" src="../mvc/views/Admin_pages/images/faces/face2.jpg" alt="profile image"> Minnie Copeland
                            </td>
                            <td>$6245</td>
                            <td><img src="../mvc/views/Admin_pages/images/dashboard/paypal.png" alt="alipay" class="gateway-icon mr-2"> Paypal</td>
                            <td>25 Sep 2019</td>
                            <td>07 Oct 2019</td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <img class="img-sm rounded-circle" src="../mvc/views/Admin_pages/images/faces/face3.jpg" alt="profile image"> Rodney Sims
                            </td>
                            <td>$9265</td>
                            <td><img src="../mvc/views/Admin_pages/images/dashboard/alipay.png" alt="alipay" class="gateway-icon mr-2"> alipay</td>
                            <td>12 dec 2019</td>
                          ...
                          <tr>
                            <td>
                              <img class="img-sm rounded-circle" src="../mvc/views/Admin_pages/images/faces/face4.jpg" alt="profile image"> Carolyn Barker
                            </td>
                            <td>$2263</td>
                            <td><img src="../mvc/views/Admin_pages/images/dashboard/alipay.png" alt="alipay" class="gateway-icon mr-2"> alipay</td>
                            <td>30 Sep 2019</td>
                    ...
                    <div class="d-flex mt-4 flex-wrap">
                      ...
                      <nav class="ml-auto">
                        <ul class="pagination separated pagination-info">
                          <li class="page-item"><a href="../mvc/views/Admin_pages/#" class="page-link"><i class="icon-arrow-left"></i></a></li>
                          <li class="page-item active"><a href="../mvc/views/Admin_pages/#" class="page-link">1</a></li>
                          <li class="page-item"><a href="../mvc/views/Admin_pages/#" class="page-link">2</a></li>
                          <li class="page-item"><a href="../mvc/views/Admin_pages/#" class="page-link">3</a></li>
                          <li class="page-item"><a href="../mvc/views/Admin_pages/#" class="page-link">4</a></li>
                          <li class="page-item"><a href="../mvc/views/Admin_pages/#" class="page-link"><i class="icon-arrow-right"></i></a></li>
                        </ul>
                      </nav>
                    </div>
                  </div>
